...
export const colors = {
  ...
  brandSurface: palette.lemon500,
  brandSurfaceText: palette.purpleMuted900,
  brandAccent: palette.purple800,
  brandAccentText: palette.lemon500,
  brandBorder: palette.gray900,
